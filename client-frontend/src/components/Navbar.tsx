        ...
        <>
            ...
            >
                <Link to="/" className="flex items-center">
                    <img src="/mainlogo.svg" alt="Logo" className="h-8.5 w-auto"/><span className="ml-2 p-2 text-2xl font-semibold">ThumbnailGen</span>
                </Link>
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    ...
                    {
                        isLoggedIn ? <Link to="/collections" className="hover:text-pink-300 transition">Collections</Link>
            ...
            <div className={`fixed inset-0 z-100 bg-black/40 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-400 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
                    ...
                    {
                        isLoggedIn? <Link onClick={() => setIsOpen(false)} to="/collections" >Collections</Link>
